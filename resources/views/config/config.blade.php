                    ...
                    <div class="w-full lg:w-4/12 px-4 mb-4">
                        <div class="relative w-full mb-3">
                            ...
                            <img id="logo" name="logo" style="height: 100px;" class="mb-2 object-cover"
                                @if (!$configs->logo) src="{{ url('upload/no_image.jpg') }}"
                                @else
                    ...
                    <div class="w-full lg:w-4/12 px-4 mb-4">
                        <div class="relative w-full mb-3">
                            ...
                            <img id="icon" name="icon" style="height: 32px;" class="mb-2"
                                @if (!$configs->icon) src="{{ url('upload/no_image.jpg') }}"
                                @else
                    ...
                    <div class="w-full lg:w-4/12 px-4 mb-4">
                        <div class="relative w-full mb-3">
                            ...
                            <img id="background" name="background" style="height: 100px;" class="mb-2"
                                @if (!$configs->background) src="{{ url('upload/no_image.jpg') }}"
                                @else
                            ...
                            <div class="flex justify-center">
                                <div class="mb-3 w-full">
                                  ...
                                  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                        ...
                                        @php
                                            $colores = ['red', 'blue', 'green', 'pink', 'purple', 'gray'];
                                        @endphp
...
@push('js')
    ...
    <script>
        ...
        // $('#menu_file_path').change(function(e) {
        //     console.log("holo");
        //     $('#new_menu').show();
        ...
        // var reader = new FileReader();
        // reader.onload = function(e) {
        // $('#menu_file').attr('src', e.target.result);
        // }
        // reader.readAsDataURL(e.target.files['0']);
        // });
    </script>
